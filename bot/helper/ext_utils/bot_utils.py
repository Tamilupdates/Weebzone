...
async def set_commands(client):
    if config_dict['SET_COMMANDS']:
        try:
            ...
            BotCommand(BotCommands.CancelMirror[0], 'Cancel a Task of yours!'),
            ...
            BotCommand(BotCommands.SearchCommand[0], 'Search in Torrent via qBit clients!'),
            BotCommand(BotCommands.HelpCommand[0], 'Get detailed help about the Bot'),
