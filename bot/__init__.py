...
app = tgClient('pyrogram', api_id=TELEGRAM_API, api_hash=TELEGRAM_HASH, session_string=USER_SESSION_STRING, workers=1000, parse_mode=enums.ParseMode.HTML, no_updates=True).start()
...
try:
    ...
    if len(USER_SESSION_STRING) != 0:
        premium_session = tgClient('premium', api_id=TELEGRAM_API, api_hash=TELEGRAM_HASH, session_string=USER_SESSION_STRING, parse_mode=enums.ParseMode.HTML, no_updates=True)
...
if len(AUTHOR_NAME) == 0:
    AUTHOR_NAME = 'TamilUpdatesOfficial'
